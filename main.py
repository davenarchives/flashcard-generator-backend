...
async def generate_flashcards(text: str) -> str:
    """Chunk large documents and fan out model requests with a concurrency cap."""
        ...
        def _call_model() -> str:
            response = client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "You are an AI tutor that creates clear, concise study flashcards.",
                    },
...
async def summarize(file: UploadFile):
    """Generate study flashcards using the configured model provider."""
